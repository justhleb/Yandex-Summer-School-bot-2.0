...
3. **Посмотреть лекции** (кнопка в меню):
...
4. **Лекции на неделю** (кнопка в меню):
...
6. **Mock Interview** (кнопка в меню):
...
1. **Добавить лекцию** (кнопка в меню):
...
2. **Удалить лекцию** (кнопка в меню):
...
3. **Изменить лекцию** (кнопка в меню):
...
4. **Отправить оповещение** (кнопка в меню):
...
5. **Сформировать пары** (кнопка в меню):
...
6. **Выйти из админки** (кнопка в меню):
...
## Примечания
- Бот работает только в Telegram. Найдите его по имени YandexSummerSchool_bot и начните с команды `/start`.
